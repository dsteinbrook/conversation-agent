...
Demo implementation of a conversational agent that follows a configurable script for a conversation. For chatbot use cases that require more structure than a default LLM, such as a videogame NPC, call center agent, or ai job interviewer.
